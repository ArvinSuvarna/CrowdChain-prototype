...
export declare const secp256k1: Readonly<{
    ...
    CURVE: Readonly<{
        ...
        readonly isTorsionFree?: ((c: import("@noble/curves/abstract/weierstrass").ProjConstructor<bigint>, point: PointType<bigint>) => boolean) | undefined;
        readonly clearCofactor?: ((c: import("@noble/curves/abstract/weierstrass").ProjConstructor<bigint>, point: PointType<bigint>) => PointType<bigint>) | undefined;
    ...
    sign: (msgHash: Hex, privKey: PrivKey, opts?: import("@noble/curves/abstract/weierstrass").SignOpts | undefined) => import("@noble/curves/abstract/weierstrass").RecoveredSignatureType;
    verify: (signature: Hex | {
        r: bigint;
        s: bigint;
    }, msgHash: Hex, publicKey: Hex, opts?: import("@noble/curves/abstract/weierstrass").VerOpts | undefined) => boolean;
...
export declare const hashToCurve: (msg: Uint8Array, options?: import("@noble/curves/abstract/hash-to-curve").htfBasicOpts | undefined) => import("@noble/curves/abstract/hash-to-curve").H2CPoint<bigint>;
export declare const encodeToCurve: (msg: Uint8Array, options?: import("@noble/curves/abstract/hash-to-curve").htfBasicOpts | undefined) => import("@noble/curves/abstract/hash-to-curve").H2CPoint<bigint>;
export {};
